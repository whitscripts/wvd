...
Set-RdsContext -TenantGroupName "WVD_Hackathon_TG"
...
$tenant = "awcdemo"
$Hostpool = "win10desktop<usernumber>"    #example:  "win10desktop01"
...
#  Size of VM to Use:  F2s
#  Domain to Join:  awcdemo.cloud
#  Domain UPN:  wvduser<UserNumber>@awcdemo.cloud 
#  OU: Leave Blank
#  Tenant Name:  WVD_Hackathon_TG
#  Existing Tenant:  awcdemo
#  Host Pool Name: wvduser<Usernumber>   # Example:  wvduser15
#  Tenant UPN:  wvduser02@awcdemo.cloud
#  Tenant Password:   wvduser Password

#  Additional Info 
#  Existing VNET: vn-sharedservices
#  Existing Subnet:  wvd
#  Resource Group:  rg-sharedservices
#  Existing Tenant:  awcdemo
#  Host Pool Name: wvduser<Usernumber>   # Example:  wvduser15
#  Tenant UPN:  wvduser02@awcdemo.cloud
#  Tenant Password:   wvduser Password
...
New-RdsAppGroup $tenant $Hostpool applications -ResourceType “RemoteApp”   #Create an App Group of type RemoteApp in Hostpool
...
Add-RdsAppGroupUser -TenantName $tenant -HostPoolName $Hostpool -AppGroupName “Desktop Application Group” -UserPrincipalName <user account>
...
New-RdsRemoteApp $tenant $Hostpool1 applications "Wordpad" -Filepath "C:\Program Files\Windows NT\Accessories\wordpad.exe" -IconPath "C:\Program Files\Windows NT\Accessories\wordpad.exe" -IconIndex 0
New-RdsRemoteApp $tenant $Hostpool1 applications "Calculator" -Filepath "C:\Windows\System32\calc.exe" -IconPath "C:\Windows\System32\calc.exe" -IconIndex 1
New-RdsRemoteApp $tenant $Hostpool1 applications "MS Paint" -Filepath "c:\windows\system32\mspaint.exe" -IconPath "c:\windows\system32\mspaint.exe" -IconIndex 2
