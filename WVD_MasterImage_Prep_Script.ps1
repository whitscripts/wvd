...
Install Sepago Agent - ITPC-LogAnalyticsAgent2
    <add key="CustomerId" value="4fa97ba4-ff09-42d8-83a9-628699570b9e"/>
    <add key="SharedKey" value="yaI8Iilnptyx1GCdeWkFTxM5OVqvb/fIyIokog8LfBd1LNKJI6yxurH2taJ/WZAmycoZ8ktv34m5Y8AdhwMUmg=="/>
    Create Sepago WS
...
REG ADD "HKLM\SOFTWARE\Policies\Microsoft\OneDrive" /v "KFMSilentOptIn" /t REG_SZ /d "b21343be-343e-42f3-8ced-ae5fdf6f8e7d" /f
...
New-ItemProperty -Path HKLM:\Software\FSLogix\Profiles -Name "VHDLocations" -Value \\fs01\UserProfiles -PropertyType MultiString -Force
